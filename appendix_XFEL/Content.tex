...
% TODO design_principles Come back and re-read this!
...
\label{sub:tx_implementation}
 %    
% The transmitter entity has 3 key responsibilities:
% \begin{itemize*}
...
% \begin{itemize}
%   \item Provide information to other entities on the command stream being sent to the ASIC (e.g. if the command \texttt{SYNC\_RESET} is sent).
